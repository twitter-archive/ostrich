  ...
  "StatsCollection" should {
    ...
    "metrics" in {
      "empty" in {
        ...
        test(true) mustEqual new Distribution(1, 0, 0, 0)
        // the timings list will be empty here:
        test(true) mustEqual new Distribution(0, 0, 0, 0)
      }
      ...
      "basic min/max/average" in {
        ...
        val test = collection.getMetric("test")
        test(true) mustEqual new Distribution(3, 3, 1, Some(Histogram(1, 2, 3)), 6)
      }
      ...
      "ignore negative timings" in {
        ...
        val test = collection.getMetric("test")
        test(true) mustEqual new Distribution(1, 1, 1, Some(Histogram(1)), 1)
      }
      ...
      "add multiple bundles of timings" in {
        val timingStat1 = new Distribution(2, 25, 15, Some(Histogram(15, 25)), 40)
      ...
      "timing stats can be added and reflected in Stats.getMetrics" in {
        ...
        Stats.addMetric("foobar", new Distribution(3, 0, 0, 0))
